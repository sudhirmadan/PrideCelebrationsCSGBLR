...
p){function t(v){return function(u){B[v]=u;w--;0==w&&n(B)}}var B=[],w=0;do B.push(void 0),w++,d(l.value).callWhenSettled_(t(B.length-1),p),l=k.next();while(!l.done)})};return f},"es6","es3");$jscomp.iteratorFromArray=function(b,c){b instanceof String&&(b+="");var d=0,e=!1,f={next:function(){if(!e&&d<b.length){var g=d++;return{value:c(g,b[g]),done:!1}}e=!0;return{done:!0,value:void 0}}};f[Symbol.iterator]=function(){return f};return f};
...
$jscomp.polyfill("WeakMap",function(b){function c(){if(!b||!Object.seal)return!1;try{var n=Object.seal({}),p=Object.seal({}),t=new b([[n,2],[p,3]]);if(2!=t.get(n)||3!=t.get(p))return!1;t.delete(n);t.set(p,4);return!t.has(n)&&4==t.get(p)}catch(B){return!1}}function d(){}function e(n){var p=typeof n;return"object"===p&&null!==n||"function"===p}function f(n){if(!$jscomp.owns(n,h)){var p=new d;$jscomp.defineProperty(n,h,{value:p})}}function g(n){if(!$jscomp.ISOLATE_POLYFILLS){var p=Object[n];p&&(Object[n]=
function(t){if(t instanceof d)return t;Object.isExtensible(t)&&f(t);return p(t)})}}if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(b&&$jscomp.ES6_CONFORMANCE)return b}else if(c())return b;var h="$jscomp_hidden_"+Math.random();g("freeze");g("preventExtensions");g("seal");var k=0,l=function(n){this.id_=(k+=Math.random()+1).toString();if(n){n=$jscomp.makeIterator(n);for(var p;!(p=n.next()).done;)p=p.value,this.set(p[0],p[1])}};l.prototype.set=function(n,p){if(!e(n))throw Error("Invalid WeakMap key");
...
f(this,l).entry)&&l.value};e.prototype.entries=function(){return g(this,function(l){return[l.key,l.value]})};e.prototype.keys=function(){return g(this,function(l){return l.key})};e.prototype.values=function(){return g(this,function(l){return l.value})};e.prototype.forEach=function(l,n){for(var p=this.entries(),t;!(t=p.next()).done;)t=t.value,l.call(n,t[1],t[0],this)};e.prototype[Symbol.iterator]=e.prototype.entries;var f=function(l,n){var p=n&&typeof n;"object"==p||"function"==p?d.has(n)?p=d.get(n):
(p=""+ ++k,d.set(n,p)):p="p_"+n;var t=l.data_[p];if(t&&$jscomp.owns(l.data_,p))for(l=0;l<t.length;l++){var B=t[l];if(n!==n&&B.key!==B.key||n===B.key)return{id:p,list:t,index:l,entry:B}}return{id:p,list:t,index:-1,entry:void 0}},g=function(l,n){var p=l.head_;return $jscomp.iteratorPrototype(function(){if(p){for(;p.head!=l.head_;)p=p.previous;for(;p.next!=p.head;)return p=p.next,{done:!1,value:n(p)};p=null}return{done:!0,value:void 0}})},h=function(){var l={};return l.previous=l.next=l.head=l},k=0;
return e},"es6","es3");
...
"{anonymous}()@"):"Unknown Stack Trace";var D=b.console&&(b.console.warn||b.console.log);D&&D.call(b.console,z,C);return m.apply(this,arguments)}}function l(m,q,r){q=q.prototype;var z=m.prototype=Object.create(q);z.constructor=m;z._super=q;r&&S(z,r)}function n(m,q){return function(){return m.apply(q,arguments)}}function p(m,q){return"function"==typeof m?m.apply(q?q[0]||e:e,q):m}function t(m,q,r){h(v(q),function(z){"undefined"!=typeof b.addEventListener?m.addEventListener(z,r,!1):m.attachEvent(z,r)})}
function B(m,q,r){h(v(q),function(z){"undefined"!=typeof b.removeEventListener?m.removeEventListener(z,r,!1):m.detachEvent(z,r,!1)})}function w(m,q){for(;m;){if(m==q)return!0;m=m.parentNode}return!1}function v(m){return m.trim().split(/\s+/g)}function u(m,q,r){if(m.indexOf&&!r)return m.indexOf(q);for(var z=0;z<m.length;){if(r&&m[z][r]==q||!r&&m[z]===q)return z;z++}return-1}function y(m){return Array.prototype.slice.call(m,0)}function x(m,q,r){for(var z=[],C=[],D=0;D<m.length;){var E=q?m[D][q]:m[D];
...
return m},remove:function(m){if(g(m,"remove",this))return this;if(m=this.get(m)){var q=this.recognizers;m=u(q,m);-1!==m&&(q.splice(m,1),this.touchAction.update())}return this},on:function(m,q){if(m!==e&&q!==e){var r=this.handlers;h(v(m),function(z){r[z]=r[z]||[];r[z].push(q)});return this}},off:function(m,q){if(m!==e){var r=this.handlers;h(v(m),function(z){q?r[z]&&r[z].splice(u(r[z],q),1):delete r[z]});return this}},emit:function(m,q){this.options.domEvents&&Ea(m,q);var r=this.handlers[m]&&this.handlers[m].slice();
...
BookInfo.isLeftPage(g[0],!0)||bookConfig.FlipDirection||(f.x-=d.parameters.width*e/4),BookInfo.isLeftPage(g[0],!0)&&!bookConfig.FlipDirection&&(f.x+=d.parameters.width*e/4))}return f}d.parameters.origin||(d.parameters.origin={x:0,y:0});g=f.x;f=f.y;var h=d.parameters.width;var k=d.parameters.height;var l=d.parameters.left-d.parameters.origin.x*(e-1)*h/100;var n=d.parameters.top-d.parameters.origin.y*(e-1)*k/100;var p=e*h,t=e*k;if(p>windowWidth){var B=windowWidth-p-l+h*e*d.parameters.zoomArea.right/
100;l=-l-h*e*d.parameters.zoomArea.left/100}else B=-l-h*e*d.parameters.zoomArea.left/100,l=windowWidth-p-l+h*e*d.parameters.zoomArea.right/100;t>windowHeight?(h=windowHeight-t-n+k*e*d.parameters.zoomArea.bottom/100,d=-n-k*e*d.parameters.zoomArea.top/100):(h=-n-k*e*d.parameters.zoomArea.top/100,d=windowHeight-t-n+k*e*d.parameters.zoomArea.bottom/100);g=Number.between(g,B,l);f=Number.between(f,h,d);return{x:parseInt(g),y:parseInt(f)}}};this.pinchMoveIn=function(d,e,f){if(!d.parameters.eventCancel&&
...
g.y!=parseInt(f.y)){d.animateInterval&&d.animateInterval.stop();var h=0,k=0,l=0;g.x!=f.x&&(h=g.x-f.x);g.y!=f.y&&(k=g.y-f.y);d.animateInterval=function(n,p){var t=$.easing.easeOutBack(null,l,0,h,20),B=$.easing.easeOutBack(null,l,0,k,20);0<l&&(t-=$.easing.easeOutBack(null,l-1,0,h,20),B-=$.easing.easeOutBack(null,l-1,0,k,20));t=d.panForMove(d,t,B);d.setZoomParameters(d,t);l++;if(20<=l||n>=p)d.animateInterval.stop(),BookInfo.getBook().bookAttachments&&BookInfo.getBook().bookAttachments.Items.find("ZoomMap").each(function(w){w.refreshArea()}),
...
this.parameters.naturalHeight=$(this).height();this.setZoomSize();var h={};h.scale=d;h.tran=e;h.origin=f;this.zoomTran=h;this.originObj(this,h.origin);try{var k=$.easing.easeOutSine,l=function(){(function(p,t){n(p,t,"Sine")}).animation(this,300)}.bind(this),n=function(p,t,B){if(p<t){B=k(null,p,this.parameters.tran.x,e.x-this.parameters.tran.x,t);var w=k(null,p,this.parameters.tran.y,e.y-this.parameters.tran.y,t);p=k(null,p,this.parameters.scale,d-this.parameters.scale,t);t={};t.scale=p;t.tran={x:B,
y:w};B=transformCSS(t);this.css(B)}else if(this.transformSetting(this,h),this.parameters.scale=d,this.parameters.toScale=d,this.parameters.zoomming=!1,this.options.onZoomed)this.options.onZoomed(h)}.bind(this);l()}catch(p){}}}};this.animateToScale=function(d,e,f,g){if(!d.parameters.eventCancel&&!d.parameters.zoomming){d.options&&d.options.zoomStart&&d.options.zoomStart();d.parameters.zoomming=!0;var h={};h.origin=d.parameters.origin;h.scale=e;h.tran=this.mathTran(d,f,h.origin);h.tran=this.tranLimit(d,
...
f=f[0];void 0==c&&(c=!1);var n=getHost(f.src),p=getHost();if(n&&p!==n){if(g=f.src.replace(n,p),f.src=g,0==c)$(f).on("load",function(){try{e.changeButtonColor(b,!0,d)}catch(u){}})}else{g.width=k;g.height=l;try{h.drawImage(f,0,0,f.naturalWidth,f.naturalHeight,0,0,k,l);var t=h.getImageData(0,0,k,l),B=h.getImageData(0,0,k,l);if(1!=f.colorChanged&&t){var w=Color(b).split();k=0;for(var v=t.data.length;k<v;k+=4)0<B.data[k+3]&&(t.data[k]!=w.r&&(B.data[k]=t.data[k]/255*w.r),t.data[k+1]!=w.g&&(B.data[k+1]=
t.data[k+1]/255*w.g),t.data[k+2]!=w.b&&(B.data[k+2]=t.data[k+2]/255*w.b));h.putImageData(B,0,0);f.src=g.toDataURL("image/png");void 0!=d&&d(e);f.colorChanged=!0}}catch(u){if(0==c)$(f).on("load",function(){try{e.changeButtonColor(b,!0,d)}catch(y){}})}}}}};
...
(function(b){function c(w,v){var u=(w&65535)+(v&65535);return(w>>16)+(v>>16)+(u>>16)<<16|u&65535}function d(w,v,u,y,x,A){w=c(c(v,w),c(y,A));return c(w<<x|w>>>32-x,u)}function e(w,v,u,y,x,A,G){return d(v&u|~v&y,w,v,x,A,G)}function f(w,v,u,y,x,A,G){return d(v&y|u&~y,w,v,x,A,G)}function g(w,v,u,y,x,A,G){return d(u^(v|~y),w,v,x,A,G)}function h(w,v){w[v>>5]|=128<<v%32;w[(v+64>>>9<<4)+14]=v;var u=1732584193,y=-271733879,x=-1732584194,A=271733878;for(v=0;v<w.length;v+=16){var G=u;var F=y;var O=x;var L=A;
u=e(u,y,x,A,w[v],7,-680876936);A=e(A,u,y,x,w[v+1],12,-389564586);x=e(x,A,u,y,w[v+2],17,606105819);y=e(y,x,A,u,w[v+3],22,-1044525330);u=e(u,y,x,A,w[v+4],7,-176418897);A=e(A,u,y,x,w[v+5],12,1200080426);x=e(x,A,u,y,w[v+6],17,-1473231341);y=e(y,x,A,u,w[v+7],22,-45705983);u=e(u,y,x,A,w[v+8],7,1770035416);A=e(A,u,y,x,w[v+9],12,-1958414417);x=e(x,A,u,y,w[v+10],17,-42063);y=e(y,x,A,u,w[v+11],22,-1990404162);u=e(u,y,x,A,w[v+12],7,1804603682);A=e(A,u,y,x,w[v+13],12,-40341101);x=e(x,A,u,y,w[v+14],17,-1502002290);
y=e(y,x,A,u,w[v+15],22,1236535329);u=f(u,y,x,A,w[v+1],5,-165796510);A=f(A,u,y,x,w[v+6],9,-1069501632);x=f(x,A,u,y,w[v+11],14,643717713);y=f(y,x,A,u,w[v],20,-373897302);u=f(u,y,x,A,w[v+5],5,-701558691);A=f(A,u,y,x,w[v+10],9,38016083);x=f(x,A,u,y,w[v+15],14,-660478335);y=f(y,x,A,u,w[v+4],20,-405537848);u=f(u,y,x,A,w[v+9],5,568446438);A=f(A,u,y,x,w[v+14],9,-1019803690);x=f(x,A,u,y,w[v+3],14,-187363961);y=f(y,x,A,u,w[v+8],20,1163531501);u=f(u,y,x,A,w[v+13],5,-1444681467);A=f(A,u,y,x,w[v+2],9,-51403784);
x=f(x,A,u,y,w[v+7],14,1735328473);y=f(y,x,A,u,w[v+12],20,-1926607734);u=d(y^x^A,u,y,w[v+5],4,-378558);A=d(u^y^x,A,u,w[v+8],11,-2022574463);x=d(A^u^y,x,A,w[v+11],16,1839030562);y=d(x^A^u,y,x,w[v+14],23,-35309556);u=d(y^x^A,u,y,w[v+1],4,-1530992060);A=d(u^y^x,A,u,w[v+4],11,1272893353);x=d(A^u^y,x,A,w[v+7],16,-155497632);y=d(x^A^u,y,x,w[v+10],23,-1094730640);u=d(y^x^A,u,y,w[v+13],4,681279174);A=d(u^y^x,A,u,w[v],11,-358537222);x=d(A^u^y,x,A,w[v+3],16,-722521979);y=d(x^A^u,y,x,w[v+6],23,76029189);u=d(y^
x^A,u,y,w[v+9],4,-640364487);A=d(u^y^x,A,u,w[v+12],11,-421815835);x=d(A^u^y,x,A,w[v+15],16,530742520);y=d(x^A^u,y,x,w[v+2],23,-995338651);u=g(u,y,x,A,w[v],6,-198630844);A=g(A,u,y,x,w[v+7],10,1126891415);x=g(x,A,u,y,w[v+14],15,-1416354905);y=g(y,x,A,u,w[v+5],21,-57434055);u=g(u,y,x,A,w[v+12],6,1700485571);A=g(A,u,y,x,w[v+3],10,-1894986606);x=g(x,A,u,y,w[v+10],15,-1051523);y=g(y,x,A,u,w[v+1],21,-2054922799);u=g(u,y,x,A,w[v+8],6,1873313359);A=g(A,u,y,x,w[v+15],10,-30611744);x=g(x,A,u,y,w[v+6],15,-1560198380);
y=g(y,x,A,u,w[v+13],21,1309151649);u=g(u,y,x,A,w[v+4],6,-145523070);A=g(A,u,y,x,w[v+11],10,-1120210379);x=g(x,A,u,y,w[v+2],15,718787259);y=g(y,x,A,u,w[v+9],21,-343485551);u=c(u,G);y=c(y,F);x=c(x,O);A=c(A,L)}return[u,y,x,A]}function k(w){var v,u="",y=32*w.length;for(v=0;v<y;v+=8)u+=String.fromCharCode(w[v>>5]>>>v%32&255);return u}function l(w){var v,u=[];u[(w.length>>2)-1]=void 0;for(v=0;v<u.length;v+=1)u[v]=0;var y=8*w.length;for(v=0;v<y;v+=8)u[v>>5]|=(w.charCodeAt(v/8)&255)<<v%32;return u}function n(w){return k(h(l(w),
8*w.length))}function p(w,v){var u=l(w),y=[],x=[];y[15]=x[15]=void 0;16<u.length&&(u=h(u,8*w.length));for(w=0;16>w;w+=1)y[w]=u[w]^909522486,x[w]=u[w]^1549556828;v=h(y.concat(l(v)),512+8*v.length);return k(h(x.concat(v),640))}function t(w){var v="",u;for(u=0;u<w.length;u+=1){var y=w.charCodeAt(u);v+="0123456789abcdef".charAt(y>>>4&15)+"0123456789abcdef".charAt(y&15)}return v}function B(w,v,u){v?u?w=p(unescape(encodeURIComponent(v)),unescape(encodeURIComponent(w))):(w=p(unescape(encodeURIComponent(v)),
unescape(encodeURIComponent(w))),w=t(w)):w=u?n(unescape(encodeURIComponent(w))):t(n(unescape(encodeURIComponent(w))));return w}"function"===typeof define&&define.amd?define(function(){return B}):"object"===typeof module&&module.exports?module.exports=B:b.md5=B})(this);String.prototype.MD5=function(b){return md5(this)};
...
var tmpBookConfig={},checkBookConfig=function(){var b=allocateUTF8(htmlConfig.bookConfig);window.key_index=Module._DeConfig_Parse(b);void 0==window.aliasConfig&&(window.aliasConfig={});tmpBookConfig.chatBotButtonIcon=getConfigValue("chatBotButtonIcon","");tmpBookConfig.ClientBookId=getConfigValue("ClientBookId","");tmpBookConfig.CreatedTime=getConfigValue("CreatedTime","");tmpBookConfig.CreatedVersion=getConfigValue("CreatedVersion","");tmpBookConfig.productName=getConfigValue("productName","");tmpBookConfig.productVersion=
getConfigValue("productVersion","");tmpBookConfig.PDFBASE_VERSION_MAC=getConfigValue("PDFBASE_VERSION_MAC","");tmpBookConfig.PDFBASE_VERSION=getConfigValue("PDFBASE_VERSION","");tmpBookConfig.isCachePages=getConfigValue("isCachePages",!1);tmpBookConfig.displayNumberOfShares=getConfigValue("displayNumberOfShares",!1);tmpBookConfig.additionalNumberOfShare=getConfigValue("additionalNumberOfShare",0);tmpBookConfig.flipSoundURL=getConfigValue("flipSoundURL","");tmpBookConfig.isTableOfContentPagesVisible=
...
!1);tmpBookConfig.disableDingDingSharing=getConfigValue("disableDingDingSharing",!1);tmpBookConfig.formBackgroundOpacity=getConfigValue("formBackgroundOpacity",1);tmpBookConfig.phoneToolbarFontSize=getConfigValue("phoneToolbarFontSize","small").toLowerCase();tmpBookConfig.EnableRecognizeQRcodePressOnMobile=getConfigValue("EnableRecognizeQRcodePressOnMobile",!1);tmpBookConfig.mobileThumbnailSearchBarVisible=getConfigValue("mobileThumbnailSearchBarVisible",!0);tmpBookConfig.loadingMainColor=getConfigValue("loadingMainColor",
"#1F2232");tmpBookConfig.loadingBackgroundColorType=getConfigValue("loadingBackgroundColorType","1");tmpBookConfig.isShowFirstOrLastPagePrompt=getConfigValue("isShowFirstOrLastPagePrompt",!0);tmpBookConfig.isShowMobileBottomFullscreenPrompts=getConfigValue("isShowMobileBottomFullscreenPrompts",!1);tmpBookConfig.SmallProgramUrl=getConfigValue("SmallProgramUrl","");tmpBookConfig.searchColor=getConfigValue("searchColor","#00ffff");tmpBookConfig.searchAlpha=getConfigValue("searchAlpha",.3);tmpBookConfig.appLogoIcon=
getConfigValue("appLogoIcon","");tmpBookConfig.HomeURL=getConfigValue("HomeURL","");tmpBookConfig.bookTitle=getConfigValue("bookTitle","FLIPBOOK");tmpBookConfig.bookDescription=getConfigValue("bookDescription","");tmpBookConfig.toolbarColor=getConfigValue("toolbarColor","#27181A");tmpBookConfig.iconColor=getConfigValue("iconColor","#FFFFFF");tmpBookConfig.toolbarColor==tmpBookConfig.iconColor&&(tmpBookConfig.iconColor=Color(tmpBookConfig.toolbarColor).reverse());tmpBookConfig.pageNumColor=getConfigValue("pageNumColor",
"#000000");tmpBookConfig.formBackgroundColor=getConfigValue("formBackgroundColor",tmpBookConfig.toolbarColor);tmpBookConfig.formFontColor=getConfigValue("formFontColor",tmpBookConfig.iconColor);tmpBookConfig.formBackgroundColor.toLocaleLowerCase()==tmpBookConfig.formFontColor.toLocaleLowerCase()&&(tmpBookConfig.formFontColor=Color(tmpBookConfig.formBackgroundColor).reverse());tmpBookConfig.loadingBackground=getConfigValue("loadingBackground","#1F2232");tmpBookConfig.loadingDisplayTime=getConfigValue("loadingDisplayTime",
0);tmpBookConfig.searchHightlightColor=getConfigValue("searchHightlightColor","#fdc606");tmpBookConfig.logoHeight=getConfigValue("logoHeight",40);tmpBookConfig.logoTop=getConfigValue("logoTop",0);tmpBookConfig.logoPadding=getConfigValue("logoPadding",0);tmpBookConfig.isFixLogoSize=getConfigValue("isFixLogoSize",!1);tmpBookConfig.HomeButtonVisible=getConfigValue("HomeButtonVisible",!1);tmpBookConfig.ShareButtonVisible=getConfigValue("ShareButtonVisible",!1);tmpBookConfig.facebookAppId=getConfigValue("facebookAppId",
"");tmpBookConfig.isInsertFrameLinkEnable=getConfigValue("isInsertFrameLinkEnable",!0);tmpBookConfig.addCurrentPage=getConfigValue("addCurrentPage",!1);tmpBookConfig.DoubleSinglePageButtonVisible=getConfigValue("DoubleSinglePageButtonVisible",!1);tmpBookConfig.ToolBarVisible=getConfigValue("ToolBarVisible",!0);tmpBookConfig.WeChatShareButtonVisible=getConfigValue("WeChatShareButtonVisible",!1);tmpBookConfig.ThumbnailsButtonVisible=getConfigValue("ThumbnailsButtonVisible",!1);tmpBookConfig.thumbnailColor=
getConfigValue("thumbnailColor",tmpBookConfig.formBackgroundColor);tmpBookConfig.thumbnailAlpha=getConfigValue("thumbnailAlpha",100);tmpBookConfig.ThumbnailSize=getConfigValue("ThumbnailSize","small");tmpBookConfig.ZoomButtonVisible=getConfigValue("ZoomButtonVisible",!1);tmpBookConfig.ZoomToolbarVisible=getConfigValue("ZoomToolbarVisible",!0);tmpBookConfig.ZoomMapVisible=getConfigValue("ZoomMapVisible",!0);tmpBookConfig.MagnifierButtonVisible=getConfigValue("MagnifierButtonVisible",!1);tmpBookConfig.SupportOperatePageZoom=
getConfigValue("SupportOperatePageZoom",!0);tmpBookConfig.TableOfContentButtonVisible=getConfigValue("TableOfContentButtonVisible",!1);if(!global.ols||0>=global.ols.length)global.ols=[],tmpBookConfig.TableOfContentButtonVisible=!1;tmpBookConfig.LargeLogoPosition=getConfigValue("LargeLogoPosition","top-left");tmpBookConfig.LargeLogoTarget=getConfigValue("LargeLogoTarget","blank");tmpBookConfig.isHideTabelOfContentNodes=getConfigValue("isHideTabelOfContentNodes",!0);tmpBookConfig.BookMarkButtonVisible=
getConfigValue("BookMarkButtonVisible",!1);tmpBookConfig.SelectTextButtonVisible=getConfigValue("SelectTextButtonVisible",!1);tmpBookConfig.SearchButtonVisible=getConfigValue("SearchButtonVisible",!1);tmpBookConfig.searchKeywordFontColor=getConfigValue("searchKeywordFontColor","#FFB000");tmpBookConfig.FullscreenButtonVisible=getConfigValue("FullscreenButtonVisible",!0);tmpBookConfig.isNeat&&(tmpBookConfig.FullscreenButtonVisible=!0);tmpBookConfig.hideMiniFullscreen=getConfigValue("hideMiniFullscreen",
!1);isIphone()&&window.top==window.self&&(tmpBookConfig.isShowMobileBottomFullscreenPrompts=!1);tmpBookConfig.updatePageNumberForFlip=getConfigValue("updatePageNumberForFlip",!1);tmpBookConfig.leastSearchChar=getConfigValue("leastSearchChar",0);tmpBookConfig.PrintButtonVisible=getConfigValue("PrintButtonVisible",!1);tmpBookConfig.MessageButtonVisible=getConfigValue("MessageButtonVisible",!1);tmpBookConfig.printWatermarkFile=getConfigValue("printWatermarkFile","");tmpBookConfig.BackgroundSoundButtonVisible=
getConfigValue("BackgroundSoundButtonVisible",!1);tmpBookConfig.BackgroundSoundURL=getConfigValue("BackgroundSoundURL","");tmpBookConfig.BackgroundSoundLoop=getConfigValue("BackgroundSoundLoop",-1);tmpBookConfig.HelpButtonVisible=getConfigValue("HelpButtonVisible",!1);tmpBookConfig.helpContentFileURL=getConfigValue("helpContentFileURL","");tmpBookConfig.helpWidth=getConfigValue("helpWidth",400);tmpBookConfig.helpHeight=getConfigValue("helpHeight",450);tmpBookConfig.showHelpContentAtFirst=getConfigValue("showHelpContentAtFirst",
!1);tmpBookConfig.aboutButtonVisible=getConfigValue("aboutButtonVisible",!1);tmpBookConfig.aboutContactInfoTxt=getConfigValue("aboutContactInfoTxt","");tmpBookConfig.AutoPlayButtonVisible=getConfigValue("AutoPlayButtonVisible",!1);tmpBookConfig.autoPlayAutoStart=getConfigValue("autoPlayAutoStart",!1);tmpBookConfig.autoPlayDuration=getConfigValue("autoPlayDuration",3);tmpBookConfig.autoPlayLoopCount=getConfigValue("autoPlayLoopCount",1);tmpBookConfig.minZoomWidth=getConfigValue("minZoomWidth",0);tmpBookConfig.minZoomHeight=
getConfigValue("minZoomHeight",0);tmpBookConfig.maxZoomWidth=getConfigValue("maxZoomWidth",0);tmpBookConfig.maxZoomHeight=getConfigValue("maxZoomHeight",0);tmpBookConfig.defaultZoomWidth=getConfigValue("defaultZoomWidth",0);tmpBookConfig.defaultZoomHeight=getConfigValue("defaultZoomHeight",0);tmpBookConfig.middleZoomWidth=getConfigValue("middleZoomWidth",0);isNaN(tmpBookConfig.middleZoomWidth)&&(tmpBookConfig.middleZoomWidth=0);tmpBookConfig.mouseWheelFlip=getConfigValue("mouseWheelFlip",!0);tmpBookConfig.DownloadButtonVisible=
...
tmpBookConfig.visibleAreaRight;tmpBookConfig.visibleAreaBottom=tmpBookConfig.bleedAreaBottom?100-parseFloat(tmpBookConfig.bleedAreaBottom):tmpBookConfig.visibleAreaBottom;tmpBookConfig.LinkDownColor=getConfigValue("LinkDownColor","#9C9C9C");tmpBookConfig.LinkAlpha=getConfigValue("LinkAlpha",.4);tmpBookConfig.googleAnalyticsID=getConfigValue("googleAnalyticsID","");tmpBookConfig.googleTagManagerID=getConfigValue("googleTagManagerID","");tmpBookConfig.language=getConfigValue("language","English");tmpBookConfig.AboutAddress=
getConfigValue("AboutAddress","");tmpBookConfig.AboutEmail=getConfigValue("AboutEmail","");tmpBookConfig.AboutMobile=getConfigValue("AboutMobile","");tmpBookConfig.AboutWebsite=getConfigValue("AboutWebsite","");tmpBookConfig.AboutDescription=getConfigValue("AboutDescription","");tmpBookConfig.AboutAuthor=getConfigValue("AboutAuthor","");tmpBookConfig.totalPageCount=getConfigValue("totalPageCount",1);tmpBookConfig.largePageWidth=getConfigValue("largePageWidth",1440);tmpBookConfig.largePageHeight=getConfigValue("largePageHeight",
1728);tmpBookConfig.normalPath=getConfigValue("normalPath","files/page/");tmpBookConfig.largePath=getConfigValue("largePath","files/large/");tmpBookConfig.thumbPath=getConfigValue("thumbPath","files/thumb/");tmpBookConfig.FlipStyle=getConfigValue("FlipStyle","flip");tmpBookConfig.FlipStyle=tmpBookConfig.FlipStyle.toLowerCase();tmpBookConfig.phoneFlipStyle=getConfigValue("phoneFlipStyle",void 0);(isPhone()||isPad())&&void 0!==tmpBookConfig.phoneFlipStyle&&(tmpBookConfig.FlipStyle=tmpBookConfig.phoneFlipStyle.toLowerCase());
tmpBookConfig.autoDoublePage=getConfigValue("autoDoublePage","auto");b=tmpBookConfig.autoDoublePage?tmpBookConfig.autoDoublePage.toLocaleLowerCase():"auto";"single"!=b&&"auto"!=b&&"double"!=b?getConfigValue("autoDoublePage",!0)?tmpBookConfig.showDoublePage="auto":tmpBookConfig.showDoublePage="single":tmpBookConfig.showDoublePage=b;tmpBookConfig.alwaysDoublePageOnMobile=getConfigValue("alwaysDoublePageOnMobile",!1);tmpBookConfig.upsideOnMobile=function(){return isPhone()||isPad()?tmpBookConfig.alwaysDoublePageOnMobile&&
window.innerHeight>window.innerWidth?!0:!1:!1};tmpBookConfig.upsideOnMobile()&&"single"!=tmpBookConfig.showDoublePage&&(tmpBookConfig.showDoublePage="double");tmpBookConfig.QRPath=getConfigValue("QRPath","files/extfile/QRURL.png");tmpBookConfig.QRCode=getConfigValue("QRCode",!1);tmpBookConfig.MiniStyle=getConfigValue("MiniStyle",!0);tmpBookConfig.AnnotationButtonVisible=getConfigValue("AnnotationButtonVisible",!1);tmpBookConfig.InstructionsButtonVisible=getConfigValue("InstructionsButtonVisible",
...
B=decodeURIComponent(t[0]);t=decodeURIComponent(t[1]||"");l[B]=t}return l}function e(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(l){var n=16*Math.random()|0;return("x"===l?n:n&3|8).toString(16)})}try{var f=b("first_visit_channel_source");if(!f||!f.uuid){var g=e(),h={channel:"",referer:document.referrer,page:window.location.href,time:(new Date).getTime(),uuid:g},k=d();k.source?h.channel=k.source:k.i?h.channel="invite_code":k.utm_code&&(h.channel=k.utm_code);c("first_visit_channel_source",
JSON.stringify(h))}}catch(l){}})();
var VERSION_NAME="6.4.9",BUILD_DATE="2024112801",BookType={normal_book:0,single_book:1,slide_book:3,singleSlide_book:6,catalog_book:7,singleCatalog_book:8},normalBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},singleBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},bookCorner={top_left:0,top_right:1,bottom_left:2,bottom_right:3},BrowserType={WEBKIT:1,OPERA:1,MOZ:2,MS:3},Direction={left:"left",right:"right",
top:"top",bottom:"bottom"},bookEvent={onCurrentPageIndexChanged:"BE_PIC",onCurrentPageIndexWillChange:"BE_PIWC",onNoNextPage:"BE_NNP",onNoPreviousPage:"BE_NPP"},PLUGIN_MAGNETICS="AbPIMagneticSlider",PLUGIN_ROTATE3D="AbPIRotationPhotoFor3D",PLUGIN_VIDEO1="VideoPlayerExemple01",PLUGIN_VIDEO2="VideoPlayerExemple02",PLUGIN_CLASSAUDIO="",KEY_CODE_ENTER=13,KEY_CODE_LEFT=37,KEY_CODE_UP=38,KEY_CODE_RIGHT=39,KEY_CODE_DOWN=40,KEY_CODE_HOME=36,KEY_CODE_END=35,KEY_CODE_PAGEUP=33,KEY_CODE_PAGEDOWN=34,KEY_CODE_DELETE=
46,KEY_CODE_F11=122,KEY_CODE_A=65,MOUSE_LEFT=1,MOUSE_MIDDLE=2,MOUSE_RIGHT=3,LOADING_WIDTH=30,LOADING_HEIGHT=30,COIL_PAGE_WIDTH=500,isTouchDevice=function(){navigator.userAgent.match(/mobile|tablet|ip(ad|hone|od)|android/i);return _agent_.browser.device==_agent_.browser.DEVICE_PHONE||isPad()};isTouch=isTouchDevice();var _event;
...
function getArticleEditor(){function b(u){if(window.isExecuteGetInverseEditor)var y=window.setInterval(function(){if(window.runArticleEditor||window.inverseEditor)window.clearInterval(y),u()},10);else window.isExecuteGetInverseEditor=!0,f(),window.articleListConfig?(e(window.articleListConfig),u(),window.runArticleEditor&&delete window.runArticleEditor):bookConfig.articleListPath&&c(bookConfig.articleListPath,function(x){d(x,u)},u,"")}function c(u,y,x,A,G){var F=new XMLHttpRequest;F.responseType=
void 0===A?"json":A;F.open("GET",u);F.send();F.onreadystatechange=function(){4===F.readyState&&(200===F.status||304===F.status?y&&y(F):"bookinfo"===G&&y?y():x&&x(y))};F.error=function(){x&&x(y)}}function d(u,y){v&&(clearTimeout(v),v=null);if(window.Module.isReady){var x=allocateUTF8(u.responseText),A=Module._DeString(x),G=UTF8ToString(A);G=eval(G);Module._free(x);Module._FreeMemory(A);e(G);y();window.runArticleEditor&&delete window.runArticleEditor}else v=setTimeout(function(){d(u,y)},100)}function e(u){(window.articleListConfig=
u)?g(u):window.inverseEditor=[]}function f(){(bookConfig.articleConfigPath||bookConfig.bookArticleConfigPath||bookConfig.periodsConfigPath&&window.book_visit&&window.book_visit.periodicalId||bookConfig.userArticleConfigPath)&&p(function(u){window.articleConfig=u.response})}function g(u){for(var y=[],x=window.bookConfig.totalPageCount,A=window.htmlConfig?window.htmlConfig.search_pages:[],G=0;G<x;G++){for(var F=A&&A.length&&A[G]?A[G].index:G,O=[],L=0;L<u.length;L++)(u[L].articles?u[L].articles:[]).forEach(function(H){if(H.isShowLinkSplited){if(H.articleTextList&&
...
x:I.rect.x,y:I.rect.y,width:I.rect.width,height:I.rect.height,rotation:"0",reflection:"false",reflectionType:"0",reflectionAlpha:"0",pageWidth:I.rect.pageWidth,pageHeight:I.rect.pageHeight}:""}I&&H.articleTextList&&H.articleTextList.length&&(H=k(H),M=h(H,I),O.push(M))}});y.push(O)}console.log("currentPageEditor",JSON.parse(JSON.stringify(y)));window.inverseEditor=y}function h(u,y){window.articleConfig||(window.articleConfig={});window.articleConfig.hotArea||(window.articleConfig.hotArea={overColor:"#4997ee",
downColor:"#4997ee",outColor:"#4997ee",overAlpha:"0.3",downAlpha:"0.5",outAlpha:"0"});var x=window.articleConfig.hotArea;return{action:{triggerEventType:"mouseDown",actionType:"com.mobiano.flipbook.pageeditor.TAnnoActionShowArticle",articleConfig:u,linkTarget:"showArticle"},annotype:"com.mobiano.flipbook.pageeditor.TAnnoLink",annoId:"202211710188056",isInverse:!0,alpha:"1",overColor:x.overColor,downColor:x.downColor,outColor:x.outColor,overAlpha:x.overAlpha,downAlpha:x.downAlpha,outAlpha:x.outAlpha,
pageViewedBool:"true",ellipseH:"0",ellipseW:"0",location:y,hint:{hintShapeColor:"0",hintShapeColor2:"8388736",hintShapeAlpha:"1",hintW:"0",hintH:"0",hintAuto:"true",hintShapeType:"2",text:""},shadow:{hasDropShadow:"false",shadowDistance:"4",shadowAngle:"270",shadowColor:"0",shadowAlpha:"0.6",shadowBlurX:"4",shadowBlurY:"4"},highlightsBool:"false",linkStatus:"1",mouseOver:"false",borderColor:"16737792"}}function k(u){u=JSON.parse(JSON.stringify(u));u.articleTextList.map(function(y){"text"===y.type&&
(y.text=y.text.replace(/\n[ ]+/g,"<br>&emsp;&emsp;"));return y});return{articleId:u.articleId,newTime:u.newTime,title:u.title,subTitle:u.subTitle,author:u.author,categoryId:u.categoryId,articleTextList:u.articleTextList}}function l(u,y){var x=[];u.forEach(function(A){-1!==y&&(A.pageIndex===y||A.mergeList&&A.mergeList.length&&A.mergeList.filter(function(G){return G.pageIndex===y}).length)&&(A.mergeList&&A.mergeList.length?(A=l(A.mergeList,y),A.length&&(x=[].concat($jscomp.arrayFromIterable(x),$jscomp.arrayFromIterable(A)))):
x.push(A.rect))});return x}function n(u,y){var x="";u.forEach(function(A){if(-1!==y&&(A.pageIndex===y||A.mergeList&&A.mergeList.length&&A.mergeList.filter(function(F){return F.pageIndex===y}).length))if(""===x)x=A.mergeList&&A.mergeList.length?n(A.mergeList,y):JSON.parse(JSON.stringify(A));else{if(A.mergeList&&A.mergeList.length){var G=[x].concat(A.mergeList);x=n(G,y)}x.rect.x>A.rect.x&&(x.rect.x=A.rect.x);x.rect.y>A.rect.y&&(x.rect.y=A.rect.y);x.rect.endX<A.rect.endX&&(x.rect.endX=A.rect.endX);x.rect.endY<
A.rect.endY&&(x.rect.endY=A.rect.endY);x.rect.width=x.rect.endX-x.rect.x;x.rect.height=x.rect.endY-x.rect.y}});return x}function p(u){bookConfig.articleConfigPath?c(bookConfig.articleConfigPath,u,t):t(u)}function t(u){bookConfig.bookArticleConfigPath?c(bookConfig.bookArticleConfigPath,u,B):B(u)}function B(u){if(bookConfig.periodsConfigPath&&window.book_visit&&window.book_visit.periodicalId){var y=bookConfig.periodsConfigPath;y=y.replace("%periodicalId%",window.book_visit.periodicalId);c(y,u,w)}else w(u)}
function w(u){bookConfig.userArticleConfigPath?c(bookConfig.userArticleConfigPath,u):u&&u()}var v;return $jscomp.asyncExecutePromiseGeneratorProgram(function(u){return u.return(new Promise(function(y,x){window.templeteName&&!window.templeteName.toLowerCase().match(/article/)?y():window.runArticleEditor||window.inverseEditor?y():(console.log("create getArticleEditor one time"),bookConfig.articleListPath?(x=bookConfig.bookBaseURL)?(x.endsWith("/")||(x+="/"),c(x+"bookinfo.js",function(A){A&&A.response&&
...
l.$parent==b&&(f=l.getWidth()+22,g+=l.getWidth()+22)}g+=2;h=b.children().length;Number.between(Math.floor((e-4-f)/(h-1)),10,65);var n=f=0,p=0;for(h=0;h<this.bookmarkList.count();h++)if(k=this.bookmarkList.item(h),l=this.bookmarkPool.getBookmarkItem(k),l.$parent==b){var t={};g>=e?(0<p&&(n=l.getWidth()>2*p/3?n+(p/2+10):n+(p-l.getWidth()/2+10)),t[c]=n,p=l.getWidth()):(t[c]=f,f+=l.getWidth()+22);t["z-index"]=d*k.pageIndex;l.setPosition(t)}},show:function(){this.visible=!0;this.refresh()},hide:function(){this.hideLeftBar();
...
B=0;B<canvasData[b].resources.length;B++)if(1!=canvasData[b].resources[B].type)t++,t>=canvasData[b].resources.length&&k();else{var w=new Image;w.src=getResource(b,B);globalImages[b][B]=w;w.onload=function(){t++;t>=canvasData[b].resources.length&&k()}}})()}.bind(l),error:function(){}});n.jumpToEnd()})})()},objectLoad=function(b,c,d,e,f,g){var h,k,l,n,p,t;return $jscomp.asyncExecutePromiseGeneratorProgram(function(B){h=0;k=$("<div style='position:relative;'></div>");k.css({width:bookConfig.largePageWidth+
"px",height:bookConfig.largePageHeight+"px"});l=function(w){bookConfig.largePageWidth/bookConfig.largePageHeight>w[0].naturalWidth/w[0].naturalHeight?w.css({width:"auto",height:"100%"}):w.css({width:"100%",height:"auto"})};for(n=0;n<c.length;n++)p=c[n],p=p.removeStartFrom("?"),t=$("<img style='position:absolute;left:0;top:0;bottom:0;right:0;margin:auto;'></img>"),t.attr("src",p),k.append(t),t[0].onload=function(w){l($(this));h++;h==c.length&&e&&e(c,c,k,b)},t[0].onerror=function(w){h++;h==c.length&&
...
function(){this.create(b,c,d)}.bind(h),function(){}),t.return();if(l=global[decodeDatabasePrefix(c)+b]&&"string"==typeof global[decodeDatabasePrefix(c)+b])return n=dataBase64Str(b,c),h.$image=$("<img src='"+n+"'/>"),h.$image[0].onload=function(){d&&d(n,k,this.$image[0],b);this.width=this.$image[0].naturalWidth;this.height=this.$image[0].naturalHeight;this.onResize(this.pageWidth,this.pageHeight)}.bind(h),t.return();p=h;loadJavascript(k,function(B){var w=dataBase64Str(b,c,B);p.$image=$("<img src='"+
...
function canvasReload(b,c,d,e){var f=b.width,g=b.height;c=Math.round(c);d=Math.round(d);var h=f/c,k=g/d,l=Math.ceil(h/2),n=Math.ceil(k/2),p=b.getContext("2d"),t=p.getImageData(0,0,f,g),B=p.createImageData(c,d);t=t.data;for(var w=B.data,v=0;v<d;v++)for(var u=0;u<c;u++){for(var y=4*(u+v*c),x,A=0,G=0,F=0,O=0,L=0,H=0,I=(v+.5)*k,K=Math.ceil((v+1)*k),M=Math.floor(v*k);M<K;M++){var W=Math.abs(I-(M+.5))/n,Z=(u+.5)*h;W*=W;for(var aa=Math.ceil((u+1)*h),T=Math.floor(u*h);T<aa;T++)if(x=Math.abs(Z-(T+.5))/l,x=
Math.sqrt(W+x*x),!(1<=x)){x=2*x*x*x-3*x*x+1;var U=4*(T+M*f);H+=x*t[U+3];G+=x;255>t[U+3]&&(x=x*t[U+3]/250);F+=x*t[U];O+=x*t[U+1];L+=x*t[U+2];A+=x}}w[y]=F/A;w[y+1]=O/A;w[y+2]=L/A;w[y+3]=H/G}!0===e?(b.width=c,b.height=d):p.clearRect(0,0,f,g);p.putImageData(B,0,0)}
...
b.type,originTotalPageCount,b.pageWidth,b.pageHeight),2):c.return(c.yieldResult)})}}),PageBackground=Class({create:function(b,c,d,e,f,g,h){var k=this,l,n,p;return $jscomp.asyncExecutePromiseGeneratorProgram(function(t){if(1==t.nextAddress){if(!b||!c)return t.return();k.type=c;return t.yield(getPageDir(b,c,originTotalPageCount),2)}l=t.yieldResult;n=getPageSize(b,c);k.imageURL=l;k.load=null;k.parent=h;p=k.getUrlType(l,n);switch(p){case 0:k.load=new CanvasLoad(b,c,d,e,f,g,h);break;case 1:k.load=new ImageLoad(b,
...
g)/Math.abs(b.toPoint.x-b.startPoint.x);e=isAndroidWeChat()||isAndroidDefault()||isIE()||isFirefox()?function(){var p=0;k=function(){n(p,25,"Sine");p++}.interval(this,l/25)}.bind(this):function(){k=function(p,t){n(p,t,"Sine")}.animation(this,l)}.bind(this);var n=function(p,t,B){if(!b)return!1;var w=b.pageWidth,v=b.pageHeight,u=$.easing["easeInOut"+B],y=$.easing["easeOut"+B];B=y(null,p,g,b.toPoint.x-g,t);y=y(null,p,h,b.toPoint.y-h,t);b.dragMoveToFlip||(B=u(null,p,g,b.toPoint.x-g,t),y=bookConfig.FlipDirection?
f*Math.sqrt(v*v-B*B):v-f*Math.sqrt(w*w-B*B));p<t?this.flipToPoint(b,c,d,b.fromPoint,{x:B,y:y}):(this.flipToPoint(b,c,d,b.fromPoint,b.toPoint),this.book.afterFlipTo(b,d),BookEvent.trigger("afterFlipPage",[d]),k.stop())}.bind(this);e()}},setFlipInterval:function(){this.flipInterval=function(){if(!this.flipIntervalManager.flipInterval||!this.flipIntervalManager.flipInterval.stop){if(this.flipPageManager&&this.flipPageManager.array&&0!=this.flipPageManager.array.length)for(var b=0;b<this.flipPageManager.array.length;b++){var c=
